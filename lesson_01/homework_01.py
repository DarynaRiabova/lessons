...
print(f"Температура надвечір: {evening_temp}°C")
...
ill_boys = 1
ill_girls = 2
children = boys + girls - ill_boys - ill_girls
print(f"Сьогодні у театральному гуртку: {children} дітей")
...
print(f"Загальна вартість книг: {total_price}")