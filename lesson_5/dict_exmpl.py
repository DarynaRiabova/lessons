space_academy = {
    ...
    "students": [
        ...
        },
        {
            ...
            "grades": {
                "Black Hole Topology": 100,
                "Quantum Mechanics IV": 97,
                "Orbital Mechanics": 99,
            },
            "emergency_contact": (
                "Grand High Hive",
                "Government",
...
space_academy["students"][0]["emergency_contact"]
...
list_of_students = space_academy["students"]

for n in list_of_students:
    print(n["name"])
    print(n["gpa"])
...
for department in space_academy["departments"].values():
    final_budget += department["budget_credits"]
